...
from app.detection.image.schema import DetectionStatusResponse
from app.detection.image.schema import DetectionResultResponse

router = APIRouter(prefix="/image", tags=["detection"])
